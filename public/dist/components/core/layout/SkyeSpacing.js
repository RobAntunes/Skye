...
// src/client/components/core/layout/SkyeSpacing.ts
var SkyeSpacing = class extends composeMixins(SkyeComponent, Responsive) {
  template() {
    return `
  ...
  handleResize() {
    const spacingContainer = this.querySelector(".spacing-container");
    if (globalThis.innerWidth < 768) {
      spacingContainer.style.padding = "var(--padding-sm)";
    } else if (globalThis.innerWidth >= 768 && globalThis.innerWidth < 1024) {
      spacingContainer.style.padding = "var(--padding-md)";
    } else {
      spacingContainer.style.padding = "var(--padding-lg)";
    }
  }
};
customElements.define("skye-spacing", SkyeSpacing);
//# sourceMappingURL=SkyeSpacing.js.map
